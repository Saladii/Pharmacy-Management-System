...
<head>
  ...
  <title>Damage Medicine List</title>
</head>
...
<body>
  ...
  <div class="container">
    ...
    ?>
    <a href="add_damage.php" class="btn btn-dark mb-3">Add New</a>

    <table class="table table-hover text-center">
      <thead class="table-dark">
        <tr>
          <th scope="col">id</th>
          <th scope="col">damage_medicine_name</th>
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td><?php echo $row["damage_medicine_name"] ?></td>
